...
import AwardsMedia from '../../scripts/components/AwardsMedia.js';
import {
  getBlockData,
...
export default function decorate(block) {
  ...
  const blockItems = block.querySelectorAll(
    existingBlockPropCnt > 0
      ? `div[data-block-name="awardsmedia"] > div:nth-child(${existingBlockPropCnt}) ~ div`
      : 'div[data-block-name="awardsmedia"] > div',
  );
  ...
  root.render(React.createElement(AwardsMedia, data));
}
