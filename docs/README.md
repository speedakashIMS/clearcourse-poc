# ClearCourse AEM
AEM Edge Delivery Services project for IMS.

## Environments
- Preview: https://main--ims-aem-foundational-kit--fastfwd.aem.page/
- Live: https://main--ims-aem-foundational-kit--fastfwd.aem.live/
...
1. Open the `clearcourse-aem` directory in your favorite IDE and start coding :)
