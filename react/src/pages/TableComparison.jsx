...
export default function TableComparisonPage() {
  const comparisonColumns = ['', 'Header', 'Header', 'Header', 'Header', 'Header'];

  const comparisonData = [
    ['Lorem', false, true, true, true, true],
    ['Lorem', true, false, true, true, true],
    ['Lorem', true, true, false, true, true],
    ['Lorem', true, true, true, false, true],
    ['Lorem', true, true, true, true, false],
    ['Lorem', true, true, true, true, true],
    ['Lorem', true, true, true, true, true],
  ];
  ...
  return (
    <div className="bg-grey-50 pb-[200px]">
      <div className="bg-grey-200">
        <div className="container py-40">
          ...
          <div className="max-w-[760px]">
            <h1 className="text-headings-h1 font-bold text-grey-950 mb-16">Comparison Table Component</h1>
            <p className="text-body-default text-grey-600 mb-24">
              Comparison table component for displaying feature comparisons with checkmarks and dashes.
            </p>
            <div className="flex flex-wrap gap-10">
              <span className="rounded-full bg-grey-200 px-12 py-6 text-[12px] font-medium text-grey-700">Comparison</span>
      ...
      <Spacer height={40} />
      <Buttons
        buttons={comparisonButtons.map(button => ({
          text: button.text,
