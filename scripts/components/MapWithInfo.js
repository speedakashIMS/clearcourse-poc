...
function N({
  ...
  return /* @__PURE__ */ f.createElement('svg', {
    ...
    'aria-labelledby': e,
    ...l,
  }, s ? /* @__PURE__ */ f.createElement('title', {
    id: e,
...
const k = /* @__PURE__ */ f.forwardRef(N); const b = ({
  text: s,
  useIcon: e = !0,
  number: l,
  stacked: c = !1,
  ...
  const i = !!c; const d = { small: 16, medium: 24, large: 32 }[m] || 24; const x = { width: `${d}px`, height: `${d}px` }; const h = i ? 'flex-col items-start' : 'flex-row items-start'; const n = i ? 'gap-8' : 'gap-12'; const a = i ? '' : 'mt-4'; const y = e ? /* @__PURE__ */ t(k, { className: `flex-shrink-0 ${a}`.trim(), style: x }) : /* @__PURE__ */ t(
    'span',
    {
  ...
  $ = ({
    ...
    className: `space-y-section-spacing-y ${d}`,
    ...x,
    children: /* @__PURE__ */ p('div', {
      className: 'relative w-full xl:aspect-[1512/522] xl:flex xl:items-center xl:justify-center',
      children: [
        o ? /* @__PURE__ */ t(
          'iframe',
          {
        ...
        /* @__PURE__ */ t('div', {
          className: 'xl:container xl:px-0',
          children: /* @__PURE__ */ t('div', {
            className: 'w-full xl:max-w-[364px] ms-auto relative z-10 bg-white p-textmedia-text--padding-x p-textmedia-text--padding-y space-y-24',
            children: /* @__PURE__ */ p('div', {
              className: 'space-y-textmedia-btn-text--spacing-y',
              children: [
                /* @__PURE__ */ p('div', {
                  ...
                  children: [
                    ...
                    e && Array.isArray(e.items) && e.items.length > 0 && (e.useIcon !== !1 ? /* @__PURE__ */ t('ul', {
                      className: 'space-y-12',
                      children: e.items.map((n, a) => /* @__PURE__ */ t(
                        b,
                        {
                          text: n.text,
                          useIcon: !0,
