...
function E({
  ...
  return /* @__PURE__ */ n.createElement('svg', {
    ...
    'aria-labelledby': t,
    ...s,
  }, r ? /* @__PURE__ */ n.createElement('title', {
    id: t,
...
const O = /* @__PURE__ */ n.forwardRef(z); const S = ({
  text: r = 'Button',
  href: t = void 0,
  variant: s = 'light',
...
function A({
  ...
  const [b, w] = j(!1); const f = M(); const a = y[c] ?? y.dark; const h = `w-full ${a.bar} relative`.trim(); const k = [
    ...
    N = o ? 'ml-auto' : 'flex-1 justify-center';
  return /* @__PURE__ */ m('nav', {
    ...
    /* @__PURE__ */ e(
        ...
        children: [
          /* @__PURE__ */ e('div', {
            ...
            children: t && /* @__PURE__ */ e('a', {
              href: '/', className: 'inline-flex shrink-0 items-center', 'aria-label': 'Home', children: typeof t === 'string' ? /* @__PURE__ */ e('img', { src: t, alt: '', className: 'h-auto min-h-32 max-h-32' }) : t,
            }),
          }),
          /* @__PURE__ */ e('div', {
            className: `hidden lg:flex items-center gap-24 ${b ? `!block absolute top-[100%] left-0 w-full ${a.mobileMenu} z-10 px-20 space-y-12 lg:space-y-0 py-10` : 'hidden'} ${N}`.trim(),
            children: s.map((l, $) => {
              let x; let
                v;
              return /* @__PURE__ */ m('div', {
                ...
                children: [
                  ...
                  ((v = l.submenu) == null ? void 0 : v.length) > 0 && /* @__PURE__ */ e('div', {
                    className: 'block lg:absolute lg:left-0 lg:top-full lg:pt-12 lg:hidden lg:group-hover:block lg:z-50',
                    children: /* @__PURE__ */ e('ul', {
                      className: `min-w-[180px] lg:rounded-8 p-nav-dd--padding ${a.dropdown}`,
                      children: l.submenu.map((p, C) => /* @__PURE__ */ e('li', {
                        children: /* @__PURE__ */ e(
                          'a',
                          {
                            href: p.href || '#',
      ...
      /* @__PURE__ */ e('div', {
        id: f, tabIndex: -1, className: 'sr-only outline-none', children: 'End of navigation',
      }),
    ],
  });
}
