...
function J({
  ...
  return /* @__PURE__ */ z.createElement('svg', {
    ...
    'aria-labelledby': c,
    ...N,
  }, n ? /* @__PURE__ */ z.createElement('title', {
    id: c,
...
const Q = /* @__PURE__ */ z.forwardRef(J); const Y = 'w-full flex items-center gap-10 text-base focus:outline-none focus:ring-1 focus:ring-grey-500 rounded-10 bg-grey-200 border border-grey-200 p-atom-text-inputs-padding-y text-grey-500'; const K = 'block mb-2 text-sm text-grey-950 font-medium'; const ee = 'relative top-[2px] text-body-small text-grey-950'; const te = 5 * 1024 * 1024; const F = ({
  type: n = 'text',
  label: c,
  additionalClasses: N = '',
  validation: b = null,
  ...
  const R = (e) => (e == null ? void 0 : e.toLowerCase().replace(/[^a-z0-9]/g, '-').replace(/-+/g, '-').replace(/^-|-$/g, '')) || 'field';
  const E = (e, s) => {
    if (y) return y;
    const a = s.name || `${Date.now()}-${Math.random().toString(36).substr(2, 9)}`;
    return `${e}-${R(a)}`;
  };
  const C = y ? `form-group-${y}` : E(`form-group-${R(c)}`, i);
  const Z = v !== void 0 ? v : '';
  const P = (e) => ({
    email: {
  ...
  const k = (e, s) => {
    let l; let d; let h; let t; let m; let
      o;
  ...
  const U = (e) => {
    const { pattern: s, title: a } = P(S); const l = new RegExp(s); const d = e.value.trim(); const h = e.required && d === ''; const
      t = d !== '' && !l.test(d);
  ...
  const T = (e) => {
    const s = e.target.value.trim(); const
      a = e.target.required && s === '';
    if (e.target.setAttribute('inputLabel', e.target.placeholder), a) e.target.setCustomValidity(p), k(e.target, !1);
    else if (e.target.required && !a && !S) e.target.setCustomValidity(''), k(e.target, !0);
    else if (S) {
      const { pattern: l, title: d } = P(S); const
        h = new RegExp(l);
  ...
  const O = (e, s) => {
    const a = document.querySelector(`span#${s}`); const
      l = e.target.files[0];
    l ? l.size > te ? (alert('File size must not exceed 5MB.'), e.target.value = '', a.textContent = '') : a.textContent = l.name : a.textContent = '';
  };
  const B = (e) => {
    const s = e.target.type === 'radio';
    const a = e.target.parentElement.querySelector('div');
    const l = a == null ? void 0 : a.querySelector('svg');
    if (s) {
  ...
  const M = () => {
    const e = y || E('select', i); const s = y ? `dropdown-${y}` : E('dropdown', i); const a = () => {
      if (v) {
      ...
      const o = document.getElementById(s); const
        g = document.querySelector(`.${s}-arrow`);
      ...
      /* @__PURE__ */ f(
          'select',
          {
            ...
            /* @__PURE__ */ r('option', { value: '' }),
              L.map((t, m) => {
                const o = typeof t === 'string' ? t : t.value ?? t; const
                  g = typeof t === 'string' ? t : t.label || o;
                return /* @__PURE__ */ r(
                  'option',
                  {
                    value: o,
  ...
  const H = () => {
    const e = n === 'radio';
    const s = y || E(e ? 'radio' : 'checkbox', i);
    return /* @__PURE__ */ f('div', {
      ...i.containerId ? { id: i.containerId } : {},
      children: [
      /* @__PURE__ */ f('div', {
  ...
  const W = () => {
    const e = y || E(n === 'textarea' ? 'textarea' : 'input', i); const s = n === 'textarea'; const a = V(); const
      l = s ? `${a} resize-none items-start` : a;
    return /* @__PURE__ */ f('div', {
      id: C,
      children: [
        /* @__PURE__ */ r('label', { htmlFor: e, className: _(), children: c }),
  ...
  re = ({ fieldKey: n = 1 }) => /* @__PURE__ */ f('form', {
    className: 'flex flex-col gap-y-form-spacing-y',
    children: [
      /* @__PURE__ */ r(
        F,
        {
      ...
      /* @__PURE__ */ r('div', {
        ...
        children: [1, 2, 3, 4, 5].map((c) => /* @__PURE__ */ r(
          F,
          {
            type: 'checkbox',
            label: 'Checkbox',
      ...
      /* @__PURE__ */ r('div', {
        ...
        children: /* @__PURE__ */ r(X, {
          text: 'Submit', variant: 'dark', size: 'btn-md', className: 'mx-auto! w-fit',
        }),
      }),
    ],
  });
