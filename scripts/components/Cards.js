...
function F({
  ...
  return /* @__PURE__ */ v.createElement('svg', {
    ...
    'aria-labelledby': s,
    ...a,
  }, r ? /* @__PURE__ */ v.createElement('title', {
    id: s,
...
const R = /* @__PURE__ */ v.forwardRef(F); const V = ({
  text: r = 'Link',
  href: s = '#',
  variant: a = 'dark',
  // dark, light
  ...
  let m;
  const n = `relative w-full h-full ${s === 'square' ? 'aspect-square' : s === 'rectangle' ? 'aspect-[4/3]' : r === 'video' ? 'aspect-video' : ''}`.trim(); const d = s === 'default' ? `w-full h-full ${l}`.trim() : `absolute inset-0 w-full h-full ${l}`.trim(); const u = 'w-full h-full'; const
    e = s === 'default' ? `min-h-[220px] md:min-h-[360px] ${d}`.trim() : d;
  switch (r) {
    case 'image':
      if (a) {
    ...
    case 'video':
      if (i) {
        let p = i;
        return (i.includes('youtube.com/watch') || i.includes('youtu.be/')) && (p = `https://www.youtube.com/embed/${i.includes('youtu.be/') ? i.split('youtu.be/')[1].split('?')[0] : (m = i.split('v=')[1]) == null ? void 0 : m.split('&')[0]}`), /* @__PURE__ */ t('div', {
          className: n,
          children: /* @__PURE__ */ t(
            'iframe',
            {
    ...
    case 'lottie':
      if (g) {
        return /* @__PURE__ */ t('div', {
          ...
          children: /* @__PURE__ */ t('div', {
            className: `${d} overflow-hidden`.trim(),
            children: /* @__PURE__ */ t(
              D,
              {
                animationData: g,
      ...
      if (f) return /* @__PURE__ */ t('div', { className: n, children: /* @__PURE__ */ t('div', { className: 'absolute inset-0 flex items-center justify-center text-body-default text-center p-40', children: 'Loading Lottie animation...' }) });
      break;
    case 'iframe':
      if (o) {
        return /* @__PURE__ */ t('div', {
  ...
  `.trim().replace(/\s+/g, ' '); const U = /* @__PURE__ */ t(
    B,
    {
      media: i,
      aspect: 'default',
  ...
  ); const I = r || s === 'left'; const
    L = () => (a === 'framed' || a === 'circle' ? /* @__PURE__ */ t('div', { className: $, children: /* @__PURE__ */ t('div', { className: k, children: U }) }) : /* @__PURE__ */ t('div', { className: M, children: U }));
  ...
  `.trim().replace(/\s+/g, ' '); const M = /* @__PURE__ */ t(
    B,
    {
      media: a,
      aspect: 'default',
  ...
  ); const w = r || s === 'left'; const
    j = () => /* @__PURE__ */ t('div', { className: N, children: /* @__PURE__ */ t('div', { className: $, children: M }) });
  return /* @__PURE__ */ b('div', {
    className: y,
    ...C ?? {},
    children: [
  ...
  H = ({
    ...
    const c = () => 'flex flex-wrap gap-y-section-spacing-y justify-center';
    const l = () => {
      const h = (e) => {
      ...
      return r === 'icon' ? a.map((e, m) => /* @__PURE__ */ t('div', {
        className: u(e),
        children: /* @__PURE__ */ t(
          q,
          {
