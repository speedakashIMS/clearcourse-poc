...
function N({
  ...
  return /* @__PURE__ */ h.createElement("svg", Object.assign({
    ...
    ref: s,
    "aria-labelledby": r
  }, i), n ? /* @__PURE__ */ h.createElement("title", {
    id: r
...
const y = /* @__PURE__ */ h.forwardRef(N), C = ({
  text: n = "Link",
  href: r = "#",
  variant: i = "dark",
  // dark, light
...
function M({
  ...
  const g = $(), l = d === "top", m = l && x === "center" ? "center" : "left", e = m === "center" ? "text-center" : "text-left", a = m === "center" ? "items-center" : "items-start", b = typeof s == "string" && /^\d{4}-\d{2}-\d{2}$/.test(s), k = l && m === "center" ? "w-[113px] h-[113px] rounded-20" : "w-[71px] h-[71px] rounded-10", v = l ? `flex flex-col gap-events-spacing-y ${a} ${e}` : "flex flex-col xl:flex-row gap-events-spacing-x items-start", w = l ? `flex flex-col gap-events-spacing-y ${a}` : "flex-1 flex flex-col gap-events-spacing-y min-w-0";
  return /* @__PURE__ */ u(
    "article",
    {
      className: v,
      ...
      ...p || {},
      children: [
        n && /* @__PURE__ */ t("div", { className: l ? "flex justify-center" : "shrink-0 w-full md:w-auto", children: /* @__PURE__ */ t(
          "img",
          {
            src: n,
            alt: r || "Event image",
        ...
        /* @__PURE__ */ u("div", { className: w, children: [
          ...
          (s || c) && /* @__PURE__ */ u("div", { className: `flex items-start gap-24 ${l ? e : ""} ${m === "center" ? "justify-center" : "justify-start"}`, children: [
          ...
          o && /* @__PURE__ */ t("div", { className: " mt-events-link--spacing-y", children: /* @__PURE__ */ t(
            C,
            {
              text: f,
              href: o,
...
function A({
  ...
  const d = (e, a, b) => a.includes(e) ? e : b, x = Math.max(1, Math.floor(r) || 1), p = d(i, ["left", "top"], "left"), g = d(s, ["left", "center"], "left");
  if (!n || n.length === 0)
    return null;
  const l = () => {
    const e = "grid gap-section-spacing-x", a = {
      1: "grid-cols-1",
  ...
  return /* @__PURE__ */ t("div", { className: `${l()} container ${f}`, id: o, children: n.map((e, a) => /* @__PURE__ */ t(
    "div",
    {
