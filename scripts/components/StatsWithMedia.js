...
const O = I(() => Promise.resolve().then(() => J)), U = ({
  ...
  var u;
  const t = typeof window < "u" && window.location.origin.indexOf("author") > -1, i = typeof window < "u" && window.matchMedia("(prefers-reduced-motion: reduce)").matches, n = `relative w-full h-full ${a === "square" ? "aspect-square" : a === "rectangle" ? "aspect-[4/3]" : l === "video" ? "aspect-video" : ""}`.trim(), c = a === "default" ? `w-full h-full ${h}`.trim() : `absolute inset-0 w-full h-full ${h}`.trim(), b = "w-full h-full", w = a === "default" ? `${c}`.trim() : c, M = f === "contain" ? "object-contain" : "object-cover", S = f === "contain" ? "xMidYMid meet" : "xMidYMid slice", d = `relative w-full ${h}`.trim(), p = "w-full min-h-[280px]";
  switch (l) {
    case "image":
      if (g)
    ...
    case "video":
      if (r) {
        const k = r.includes("youtube.com/watch") || r.includes("youtu.be/");
        let N = r;
        k && (N = `https://www.youtube.com/embed/${r.includes("youtu.be/") ? r.split("youtu.be/")[1].split("?")[0] : (u = r.split("v=")[1]) == null ? void 0 : u.split("&")[0]}`);
        const _ = (() => {
          if (!k) return N;
          try {
            const $ = new URL(N);
        ...
        return /* @__PURE__ */ e("div", { className: n, children: k ? /* @__PURE__ */ e(
          "iframe",
          {
            src: _,
    ...
    case "lottie":
      if (x)
        return t ? /* @__PURE__ */ e("div", { className: n, role: "img", "aria-label": s || "Animation", children: /* @__PURE__ */ e(
          "div",
          {
      ...
      if (y)
        return /* @__PURE__ */ e("div", { className: n, children: /* @__PURE__ */ e("div", { className: "absolute inset-0 flex items-center justify-center text-body-default text-center p-40", children: "Loading Lottie animation..." }) });
      break;
    case "iframe":
      if (v)
        return /* @__PURE__ */ e("div", { className: n, children: /* @__PURE__ */ e(
  ...
  return /* @__PURE__ */ e("div", { className: n, children: /* @__PURE__ */ e("div", { className: `flex items-center justify-center text-body-default text-center p-40 ${a === "default" ? "" : "absolute inset-0"}`.trim(), children: l ? `${l.charAt(0).toUpperCase() + l.slice(1)} placeholder` : "Image/Video/Lottie/iframe" }) });
};
function V({
  media: l,
  ...
  const y = {
    ...
    right: "ml-auto",
    center: "mx-auto"
  }, m = ["center", "left", "right"].includes(g) ? g : "center", s = ["sm", "md", "lg", "xl"].includes(r) ? r : "sm", h = y[s], t = x[m], i = v[m], o = l ? {
    media: l.media || "image",
  ...
  return /* @__PURE__ */ F(
    "div",
    {
      ...
      children: [
        ...
        a && /* @__PURE__ */ e("div", { className: `${h} font-normal`, children: a }),
        f && /* @__PURE__ */ e("div", { dangerouslySetInnerHTML: { __html: f } })
      ]
    }
  );
}
function Z({
  ...
  const x = (t, i, o) => i.includes(t) ? t : o, v = (t) => {
    const { statAlign: i = "left" } = t;
    return x(i, ["left", "right"], "left");
  }, m = (t) => {
    const { media: i, statMedia: o, ...n } = t;
    return {
      ...n,
      media: o,
      textAlign: t.textAlign || a,
  ...
  return !l || l.length === 0 ? null : /* @__PURE__ */ e("div", { className: `container ${y}`, id: r, children: l.map((t, i) => {
    const o = t.media, n = !!o, c = `${n ? "xl:w-1/2" : "w-full"}`, b = v(t) === "left", w = g === "media-first";
    return /* @__PURE__ */ e("div", { ...t.attributes ?? {}, children: /* @__PURE__ */ F("div", { className: "flex flex-col xl:flex-row items-stretch", children: [
      w && n && /* @__PURE__ */ e("div", { className: "w-full xl:w-1/2", children: h(o, t.description || "") }),
      b && s(t, c),
      !w && n && /* @__PURE__ */ e("div", { className: "w-full xl:w-1/2", children: h(o, t.description || "") }),
      !b && s(t, c)
    ] }) }, i);
...
const H = async () => {
...
}, Y = W(({ children: l }, a) => /* @__PURE__ */ e("div", { ref: a, className: "w-full h-full overflow-hidden", children: l })), G = ({ pdfUrl: l, title: a, width: f = 280, height: g = 280, className: r = "" }) => {
  const [y, x] = j(0), [v, m] = j(null), [s, h] = j(!0), [t, i] = j(g / f), [o, n] = j(0), c = B(null);
  A(() => {
    Promise.all([H(), q()]).then(() => h(!1)).catch(() => {
  ...
  const b = o > 0 ? Math.floor(o / 2) : Math.floor(f / 2), w = Math.round(b * t), M = R(async (d) => {
    try {
