...
function I({
  ...
  return /* @__PURE__ */ i.createElement("svg", Object.assign({
    ...
    ref: o,
    "aria-labelledby": l
  }, n), r ? /* @__PURE__ */ i.createElement("title", {
    id: l
...
const _ = /* @__PURE__ */ i.forwardRef(X), q = ({
  text: r = "Button",
  href: l = void 0,
  variant: n = "light",
  ...
  ...o
}) => !r || r.length === 0 ? null : /* @__PURE__ */ e("div", { className: `container ${n}`, ...o, children: r.map((c, b) => /* @__PURE__ */ e(
  q,
  {
    text: c.text,
    variant: c.variant,
...
function K({
  ...
  const [N, $] = M(!1), [k, v] = M({}), [d, j] = M(null), B = F(), z = r ? "w-full max-w-[1600px] mx-auto bg-grey-700" : "container", O = c ? "ml-auto" : "flex-1 justify-center", E = b === "light" ? "text-white hover:text-white/80 focus-visible:text-white/80" : "text-grey-600 hover:text-grey-950 focus-visible:text-grey-950", T = (t) => {
    ...
    const s = Math.min(t.length, 5), m = a ? "space-y-24" : T(s);
    return /* @__PURE__ */ e("div", { className: m, children: t.slice(0, 5).map((u, g) => /* @__PURE__ */ h("div", { className: "space-y-12", children: [
      u.title && /* @__PURE__ */ e("p", { className: "text-ui-label-small text-grey-300", children: u.title }),
      /* @__PURE__ */ e("ul", { className: "space-y-10", children: (u.links || []).map((f, x) => /* @__PURE__ */ e("li", { children: /* @__PURE__ */ e(
        "a",
        {
          href: f.href || "#",
    ...
    if (m.variant === "tabs") {
      ...
      const g = s ? k[a] : k[a] ?? 0, f = g != null ? u[Math.min(g, u.length - 1)] : null;
      return /* @__PURE__ */ h("div", { className: s ? "space-y-24" : "grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-32", children: [
        (!s || !f) && /* @__PURE__ */ e("div", { className: `flex flex-col gap-10 items-start ${s ? "flex flex-wrap gap-12" : ""}`.trim(), children: u.map((x, C) => /* @__PURE__ */ h(
          "button",
          {
            type: "button",
            onClick: () => v((A) => ({ ...A, [a]: C })),
        ...
        /* @__PURE__ */ h("div", { className: s ? "space-y-16" : "space-y-20", children: [
          s && f && /* @__PURE__ */ e(
            "button",
            {
              type: "button",
  ...
  return /* @__PURE__ */ h("nav", { className: `${z} relative ${y}`.trim(), ...p, children: [
    ...
    /* @__PURE__ */ h("div", { className: "flex items-center gap-nav-spacing-x bg-grey-700 pt-nav-padding-t pb-nav-padding-b pl-nav-padding-l pr-nav-padding-r relative", children: [
      ...
      /* @__PURE__ */ e("div", { className: `hidden lg:flex items-center gap-24 ${O}`.trim(), children: n.map((t, a) => /* @__PURE__ */ h("div", { className: "group static", children: [
        t.mega ? /* @__PURE__ */ e(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ e(
      "div",
      {
        ...
        children: /* @__PURE__ */ e("div", { className: "space-y-24", children: n.map((t, a) => /* @__PURE__ */ h("div", { className: "space-y-16", children: [
          t.mega ? /* @__PURE__ */ e(
            "button",
            {
              type: "button",
