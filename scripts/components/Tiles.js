...
function M({
  ...
  return /* @__PURE__ */ b.createElement('svg', {
    ...
    'aria-labelledby': r,
    ...l,
  }, s ? /* @__PURE__ */ b.createElement('title', {
    id: r,
...
const R = /* @__PURE__ */ b.forwardRef(M); const j = ({
  text: s = 'Link',
  href: r = '#',
  variant: l = 'dark',
  // dark, light
...
const G = /* @__PURE__ */ b.forwardRef(L); const S = ({
  text: s,
  useIcon: r = !0,
  number: l,
  stacked: n = !1,
  ...
  const c = !!n; const i = { small: 16, medium: 24, large: 32 }[d] || 24; const a = { width: `${i}px`, height: `${i}px` }; const h = c ? 'flex-col items-start' : 'flex-row items-start'; const p = c ? 'gap-8' : 'gap-12'; const u = c ? '' : 'mt-4'; const w = r ? /* @__PURE__ */ t(G, { className: `flex-shrink-0 ${u}`.trim(), style: a }) : /* @__PURE__ */ t(
    'span',
    {
  ...
  const p = (i || 'primary').toLowerCase(); const u = {
    ...
    ${u[p] || u.primary}
    ${a}
  `.trim().replace(/\s+/g, ' '); const z = e ? {
    backgroundImage: `url(${e})`,
    backgroundSize: 'cover',
    backgroundPosition: 'center',
    backgroundRepeat: 'no-repeat',
  } : void 0; const C = typeof o === 'string' ? o.trim().length > 0 : !!o; const k = (m) => typeof m === 'string' && m.trim().length > 0; const $ = n && Array.isArray(n.items) && n.items.length > 0; const B = k(s) || k(r) || k(l) || $; const v = c === 'link' && k(d) && C; const
    N = c === 'button' && k(d) && C;
  return /* @__PURE__ */ f(
    'div',
    {
      ...
      children: [
        ...
        /* @__PURE__ */ f('div', {
          className: 'relative z-10 max-w-[520px] min-h-[280px] flex flex-col items-start justify-end',
          children: [
          /* @__PURE__ */ f('div', {
              ...
              children: [
                ...
                $ && (n.useIcon !== !1 ? /* @__PURE__ */ t('ul', {
                  className: 'mt-24 space-y-12',
                  children: n.items.map((m, x) => /* @__PURE__ */ t(
                    S,
                    {
                      text: m.text,
                      useIcon: !0,
  ...
  A = ({
    ...
    const o = () => {
      const e = r === 'full' ? 'gap-0' : 'gap-24';
      const a = [3, 5, 6].includes(s) ? 'lg:grid-cols-6' : `lg:grid-cols-${s}`;
      switch (s) {
        case 1:
    ...
    return /* @__PURE__ */ t('div', {
      ...
      children: /* @__PURE__ */ t('div', {
        className: r === 'contained' ? 'container' : '',
        children: /* @__PURE__ */ t('div', {
          className: o(),
          children: l.map((e, i) => /* @__PURE__ */ t(
            I,
            {
              title: e.title,
