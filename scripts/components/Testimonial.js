...
import fe, { useMemo as We, Children as ct, isValidElement as qe, cloneElement as Ue } from "react";
...
function pt(i) {
  ...
  return Object.defineProperty(g, "__esModule", { value: !0 }), Object.keys(i).forEach(function(b) {
    var m = Object.getOwnPropertyDescriptor(i, b);
...
function vt() {
  if (Fe) return Le;
  Fe = 1;
  var i = "Expected a function", a = NaN, g = "[object Symbol]", b = /^\s+|\s+$/g, m = /^[-+]0x[0-9a-f]+$/i, S = /^0b[01]+$/i, M = /^0o[0-7]+$/i, L = parseInt, D = typeof Oe == "object" && Oe && Oe.Object === Object && Oe, z = typeof self == "object" && self && self.Object === Object && self, R = D || z || Function("return this")(), H = Object.prototype, N = H.toString, Q = Math.max, I = Math.min, x = function() {
    return R.Date.now();
  };
  function ee(s, c, d) {
    var p, l, r, h, v, o, f = 0, w = !1, k = !1, t = !0;
    ...
    (function() {
      ...
      function b(S) {
        ...
        if (typeof S != "object")
          return "";
        if (Array.isArray(S))
          return g.apply(null, S);
        if (S.toString !== Object.prototype.toString && !S.toString.toString().includes("[native code]"))
          return S.toString();
        var M = "";
        for (var L in S)
          a.call(S, L) && S[L] && (M = m(M, L));
        return M;
      }
      function m(S, M) {
...
function Se() {
  ...
  function S(u) {
    for (var e = 1; e < arguments.length; e++) {
      ...
      e % 2 ? m(Object(n), !0).forEach(function(y) {
        M(u, y, n[y]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(u, Object.getOwnPropertyDescriptors(n)) : m(Object(n)).forEach(function(y) {
  ...
  function M(u, e, n) {
    return (e = L(e)) in u ? Object.defineProperty(u, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : u[e] = n, u;
  }
  function L(u) {
    var e = D(u, "string");
  ...
  }, Q = E.lazyEndIndex = function(e) {
    return e.currentSlide + x(e);
  }, I = E.lazySlidesOnLeft = function(e) {
    return e.centerMode ? Math.floor(e.slidesToShow / 2) + (parseInt(e.centerPadding) > 0 ? 1 : 0) : 0;
  }, x = E.lazySlidesOnRight = function(e) {
    return e.centerMode ? Math.floor((e.slidesToShow - 1) / 2) + 1 + (parseInt(e.centerPadding) > 0 ? 1 : 0) : e.slidesToShow;
  }, ee = E.getWidth = function(e) {
    return e && e.offsetWidth || 0;
  }, U = E.getHeight = function(e) {
    return e && e.offsetHeight || 0;
  }, Y = E.getSwipeDirection = function(e) {
    var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, y, T, O, C;
  ...
  E.extractObject = function(e, n) {
    ...
    var n = i.default.Children.count(e.children), y = e.listRef, T = Math.ceil(ee(y)), O = e.trackRef && e.trackRef.node, C = Math.ceil(ee(O)), P;
    if (e.vertical)
      P = T;
    else {
    ...
    var $ = y && U(y.querySelector('[data-index="0"]')), F = $ * e.slidesToShow, B = e.currentSlide === void 0 ? e.initialSlide : e.currentSlide;
    e.rtl && e.currentSlide === void 0 && (B = n - 1 - e.initialSlide);
    var Z = e.lazyLoadedList || [], V = H(S(S({}, e), {}, {
      currentSlide: B,
      lazyLoadedList: Z
    }));
    Z = Z.concat(V);
    ...
    var n = e.waitForAnimate, y = e.animating, T = e.fade, O = e.infinite, C = e.index, P = e.slideCount, j = e.lazyLoad, $ = e.currentSlide, F = e.centerMode, B = e.slidesToScroll, Z = e.slidesToShow, V = e.useCSS, G = e.lazyLoadedList;
    if (n && y) return {};
    var q = C, K, re, A, te = {}, ne = {}, ie = O ? C : z(C, 0, P - 1);
    if (T) {
      if (!O && (C < 0 || C >= P)) return {};
    ...
    var y, T, O, C, P, j = e.slidesToScroll, $ = e.slidesToShow, F = e.slideCount, B = e.currentSlide, Z = e.targetSlide, V = e.lazyLoad, G = e.infinite;
    if (C = F % j !== 0, y = C ? 0 : (F - B) % j, n.message === "previous")
      O = y === 0 ? j : $ - y, P = B - O, V && !G && (T = B - O, P = T === -1 ? F - 1 : T), G || (P = Z - j);
    else if (n.message === "next")
      O = y === 0 ? j : y, P = B + O, V && !G && (P = (B + j) % F + y), G || (P = Z + j);
      ...
      if (P = n.index, G) {
        ...
        P > n.currentSlide && q === "left" ? P = P - F : P < n.currentSlide && q === "right" && (P = P + F);
      }
    ...
    var y = n.scrolling, T = n.animating, O = n.vertical, C = n.swipeToSlide, P = n.verticalSwiping, j = n.rtl, $ = n.currentSlide, F = n.edgeFriction, B = n.edgeDragged, Z = n.onEdge, V = n.swiped, G = n.swiping, q = n.slideCount, K = n.slidesToScroll, re = n.infinite, A = n.touchObject, te = n.swipeEvent, ne = n.listHeight, ie = n.listWidth;
    if (!y) {
      if (T) return R(e);
      O && C && P && R(e);
      var oe, ue = {}, we = r(n);
      ...
      var Ae = Math.round(Math.sqrt(Math.pow(A.curY - A.startY, 2)));
      if (!P && !G && Ae > 10)
        return {
          scrolling: !0
        };
      P && (A.swipeLength = Ae);
      var pe = (j ? -1 : 1) * (A.curX > A.startX ? 1 : -1);
      P && (pe = A.curY > A.startY ? 1 : -1);
      var ut = Math.ceil(q / K), le = Y(n.touchObject, P), he = A.swipeLength;
    ...
    var y = n.dragging, T = n.swipe, O = n.touchObject, C = n.listWidth, P = n.touchThreshold, j = n.verticalSwiping, $ = n.listHeight, F = n.swipeToSlide, B = n.scrolling, Z = n.onSwipe, V = n.targetSlide, G = n.currentSlide, q = n.infinite;
    if (!y)
      return T && R(e), {};
    var K = j ? $ / P : C / P, re = Y(O, j), A = {
      dragging: !1,
      edgeDragged: !1,
      scrolling: !1,
      swiping: !1,
  ...
  var X = E.getNavigableIndexes = function(e) {
    for (var n = e.infinite ? e.slideCount * 2 : e.slideCount, y = e.infinite ? e.slidesToShow * -1 : 0, T = e.infinite ? e.slidesToShow * -1 : 0, O = []; y < n; )
      O.push(y), y = T + e.slidesToScroll, T += Math.min(e.slidesToScroll, e.slidesToShow);
    return O;
  }, s = E.checkNavigable = function(e, n) {
    var y = X(e), T = 0;
    if (n > y[y.length - 1])
      n = y[y.length - 1];
    else
    ...
    return n;
  }, c = E.getSlideCount = function(e) {
    var n = e.centerMode ? e.slideWidth * Math.floor(e.slidesToShow / 2) : 0;
    if (e.swipeToSlide) {
      var y, T = e.listRef, O = T.querySelectorAll && T.querySelectorAll(".slick-slide") || [];
      if (Array.from(O).every(function(j) {
        if (e.vertical) {
          if (j.offsetTop + U(j) / 2 > e.swipeLeft * -1)
            return y = j, !1;
        ...
        return 0;
      var C = e.rtl === !0 ? e.slideCount - e.currentSlide : e.currentSlide, P = Math.abs(y.dataset.index - C) || 1;
      return P;
    } else
      return e.slidesToScroll;
  }, d = E.checkSpecKeys = function(e, n) {
    return n.reduce(function(y, T) {
      return y && e.hasOwnProperty(T);
    }, !0) ? null : console.error("Keys Missing:", e);
  }, p = E.getTrackCSS = function(e) {
    d(e, ["left", "variableWidth", "slideCount", "slidesToShow", "slideWidth"]);
    var n, y;
    if (!e.vertical)
      n = o(e) * e.slideWidth;
    else {
      var T = e.unslick ? e.slideCount : e.slideCount + 2 * e.slidesToShow;
      y = T * e.slideHeight;
    }
    var O = {
      opacity: 1,
    ...
    var n = e.slideIndex, y = e.trackRef, T = e.infinite, O = e.centerMode, C = e.slideCount, P = e.slidesToShow, j = e.slidesToScroll, $ = e.slideWidth, F = e.listWidth, B = e.variableWidth, Z = e.slideHeight, V = e.fade, G = e.vertical, q = 0, K, re, A = 0;
    if (V || e.slideCount === 1)
      return 0;
    var te = 0;
  ...
  }, v = E.getPostClones = function(e) {
    return e.unslick || !e.infinite ? 0 : e.variableWidth ? e.slideCount : e.slidesToShow + (e.centerMode ? 1 : 0);
  }, o = E.getTotalSlides = function(e) {
    return e.slideCount === 1 ? 1 : h(e) + e.slideCount + v(e);
  }, f = E.siblingDirection = function(e) {
    ...
    var n = e.slidesToShow, y = e.centerMode, T = e.rtl, O = e.centerPadding;
    if (y) {
      var C = (n - 1) / 2 + 1;
  ...
  var t = E.validSettings = Object.keys(a.default);
  function W(u) {
...
function gt() {
  ...
  function S() {
    return S = Object.assign ? Object.assign.bind() : function(l) {
      for (var r = 1; r < arguments.length; r++) {
        var h = arguments[r];
        for (var v in h)
          ({}).hasOwnProperty.call(h, v) && (l[v] = h[v]);
      }
      return l;
  ...
  function U(l) {
    for (var r = 1; r < arguments.length; r++) {
      ...
      r % 2 ? ee(Object(h), !0).forEach(function(v) {
        Y(l, v, h[v]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(l, Object.getOwnPropertyDescriptors(h)) : ee(Object(h)).forEach(function(v) {
  ...
  var s = function(r) {
    ...
    var h, v = [], o = [], f = [], w = i.default.Children.count(r.children), k = (0, g.lazyStartIndex)(r), t = (0, g.lazyEndIndex)(r);
    return i.default.Children.forEach(r.children, function(W, u) {
      var e, n = {
        message: "children",
        index: u,
  ...
  return ge.Track = /* @__PURE__ */ (function(l) {
    ...
    function h() {
      var v;
      M(this, h);
      for (var o = arguments.length, f = new Array(o), w = 0; w < o; w++)
        f[w] = arguments[w];
      return v = r.call.apply(r, [this].concat(f)), Y(Q(v), "node", null), Y(Q(v), "handleRef", function(k) {
        v.node = k;
      }), v;
    }
    return D(h, [{
      key: "render",
      value: function() {
        var o = p(this.props), f = this.props, w = f.onMouseEnter, k = f.onMouseOver, t = f.onMouseLeave, W = {
          onMouseEnter: w,
          onMouseOver: k,
          onMouseLeave: t
        };
...
function yt() {
  ...
  function M(s) {
    for (var c = 1; c < arguments.length; c++) {
      ...
      c % 2 ? S(Object(d), !0).forEach(function(p) {
        L(s, p, d[p]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(s, Object.getOwnPropertyDescriptors(d)) : S(Object(d)).forEach(function(p) {
  ...
  function L(s, c, d) {
    return (c = H(c)) in s ? Object.defineProperty(s, c, { value: d, enumerable: !0, configurable: !0, writable: !0 }) : s[c] = d, s;
  }
  function D(s, c) {
    ...
    return R(d, [{
      ...
      value: function() {
        for (var l = this.props, r = l.onMouseEnter, h = l.onMouseOver, v = l.onMouseLeave, o = l.infinite, f = l.slidesToScroll, w = l.slidesToShow, k = l.slideCount, t = l.currentSlide, W = X({
          ...
          var y = (n + 1) * f - 1, T = o ? y : (0, b.clamp)(y, 0, k - 1), O = T - (f - 1), C = o ? O : (0, b.clamp)(O, 0, k - 1), P = (0, g.default)({
...
function mt() {
  ...
  function S() {
    return S = Object.assign ? Object.assign.bind() : function(s) {
      for (var c = 1; c < arguments.length; c++) {
        var d = arguments[c];
        for (var p in d)
          ({}).hasOwnProperty.call(d, p) && (s[p] = d[p]);
      }
      return s;
    }, S.apply(null, arguments);
  }
  ...
  function L(s) {
    for (var c = 1; c < arguments.length; c++) {
      var d = arguments[c] != null ? arguments[c] : {};
      c % 2 ? M(Object(d), !0).forEach(function(p) {
        D(s, p, d[p]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(s, Object.getOwnPropertyDescriptors(d)) : M(Object(d)).forEach(function(p) {
        Object.defineProperty(s, p, Object.getOwnPropertyDescriptor(d, p));
      });
    }
    return s;
  ...
  function D(s, c, d) {
    return (c = N(c)) in s ? Object.defineProperty(s, c, { value: d, enumerable: !0, configurable: !0, writable: !0 }) : s[c] = d, s;
  }
  function z(s, c) {
    if (!(s instanceof c)) throw new TypeError("Cannot call a class as a function");
  }
...
var it = (function() {
  ...
  function i(a, g) {
    var b = -1;
    return a.some(function(m, S) {
      return m[0] === g ? (b = S, !0) : !1;
    }), b;
  }
  return (
    /** @class */
    (function() {
      ...
      return Object.defineProperty(a.prototype, "size", {
        ...
        b === void 0 && (b = null);
        for (var m = 0, S = this.__entries__; m < S.length; m++) {
          var M = S[m];
          g.call(b, M[1], M[0]);
        }
      }, a;
...
})(), Ie = typeof window < "u" && typeof document < "u" && window.document === document, xe = (function() {
...
function wt(i, a) {
  ...
  function L() {
    ...
    if (g) {
      ...
      g = !0, b = !1, setTimeout(M, a);
    m = D;
  }
  return L;
}
var Ot = 20, _t = ["top", "right", "bottom", "left", "width", "height", "size", "weight"], xt = typeof MutationObserver < "u", kt = (
  /** @class */
  (function() {
    function i() {
    ...
    return i.prototype.addObserver = function(a) {
      ...
      var g = this.observers_, b = g.indexOf(a);
      ...
      var a = this.observers_.filter(function(g) {
      ...
      var g = a.propertyName, b = g === void 0 ? "" : g, m = _t.some(function(S) {
        return !!~b.indexOf(S);
      });
      m && this.refresh();
...
function Ze(i) {
  for (var a = [], g = 1; g < arguments.length; g++)
    a[g - 1] = arguments[g];
  return a.reduce(function(b, m) {
    var S = i["border-" + m + "-width"];
    return b + ke(S);
  }, 0);
}
function Pt(i) {
  for (var a = ["top", "right", "bottom", "left"], g = {}, b = 0, m = a; b < m.length; b++) {
    var S = m[b], M = i["padding-" + S];
    g[S] = ke(M);
  }
  return g;
}
...
function Ct(i) {
  var a = i.clientWidth, g = i.clientHeight;
  if (!a && !g)
    return at;
  var b = de(i).getComputedStyle(i), m = Pt(b), S = m.left + m.right, M = m.top + m.bottom, L = ke(b.width), D = ke(b.height);
  if (b.boxSizing === "border-box" && (Math.round(L + S) !== a && (L -= Ze(b, "left", "right") + S), Math.round(D + M) !== g && (D -= Ze(b, "top", "bottom") + M)), !Et(i)) {
    var z = Math.round(L + S) - a, R = Math.round(D + M) - g;
...
function Mt(i) {
  var a = i.x, g = i.y, b = i.width, m = i.height, S = typeof DOMRectReadOnly < "u" ? DOMRectReadOnly : Object, M = Object.create(S.prototype);
  return ot(M, {
    x: a,
    y: g,
    width: b,
...
function Te(i, a, g, b) {
  return { x: i, y: a, width: g, height: b };
}
var Rt = (
  /** @class */
  (function() {
  ...
  (function() {
    function i(a, g, b) {
      if (this.activeObservations_ = [], this.observations_ = new it(), typeof a != "function")
    ...
    return i.prototype.observe = function(a) {
      ...
      if (this.hasActive()) {
        var a = this.callbackCtx_, g = this.activeObservations_.map(function(b) {
  ...
  /* @__PURE__ */ (function() {
    function i(a) {
      ...
      if (!arguments.length)
        throw new TypeError("1 argument required, but only 0 present.");
      var g = kt.getInstance(), b = new zt(a, g, this);
      lt.set(this, b);
    }
    return i;
  })()
...
const It = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Dt
}, Symbol.toStringTag, { value: "Module" })), At = /* @__PURE__ */ pt(It);
var Je;
function Ht() {
  if (Je) return ve;
  ...
  var i = z(fe), a = z(ht()), g = z(vt()), b = z(Pe()), m = Se(), S = gt(), M = yt(), L = mt(), D = z(At);
  function z(o) {
  ...
  function H() {
    return H = Object.assign ? Object.assign.bind() : function(o) {
      for (var f = 1; f < arguments.length; f++) {
        var w = arguments[f];
        for (var k in w)
          ({}).hasOwnProperty.call(w, k) && (o[k] = w[k]);
      }
      return o;
  ...
  function N(o, f) {
    ...
    if (Object.getOwnPropertySymbols) {
      ...
      for (k = 0; k < W.length; k++)
        w = W[k], f.includes(w) || {}.propertyIsEnumerable.call(o, w) && (t[w] = o[w]);
    }
    return t;
  }
  function Q(o, f) {
  ...
  function x(o) {
    for (var f = 1; f < arguments.length; f++) {
      ...
      f % 2 ? I(Object(w), !0).forEach(function(k) {
        r(o, k, w[k]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(o, Object.getOwnPropertyDescriptors(w)) : I(Object(w)).forEach(function(k) {
  ...
  function r(o, f, w) {
    return (f = h(f)) in o ? Object.defineProperty(o, f, { value: w, enumerable: !0, configurable: !0, writable: !0 }) : o[f] = w, o;
  }
  function h(o) {
    var f = v(o, "string");
  ...
  return ve.InnerSlider = /* @__PURE__ */ (function(o) {
    ...
    function w(k) {
      var t;
      ee(this, w), t = f.call(this, k), r(d(t), "listRefHandler", function(u) {
        return t.list = u;
      }), r(d(t), "trackRefHandler", function(u) {
        return t.track = u;
        ...
        if (t.props.onInit && t.props.onInit(), t.props.lazyLoad) {
          var u = (0, m.getOnDemandLazySlides)(x(x({}, t.props), t.state));
      ...
      }), r(d(t), "componentDidUpdate", function(u) {
        if (t.checkImagesLoad(), t.props.onReInit && t.props.onReInit(), t.props.lazyLoad) {
          var e = (0, m.getOnDemandLazySlides)(x(x({}, t.props), t.state));
        ...
        var n = x(x({
          listRef: t.list,
          trackRef: t.track
        }, t.props), t.state), y = t.didPropsChange(u);
        y && t.updateState(n, y, function() {
      ...
      }), r(d(t), "onWindowResized", function(u) {
        t.debouncedResize && t.debouncedResize.cancel(), t.debouncedResize = (0, g.default)(function() {
      ...
      }), r(d(t), "updateState", function(u, e, n) {
        var y = (0, m.initializedState)(u);
        u = x(x(x({}, u), y), {}, {
          slideIndex: y.currentSlide
        });
        var T = (0, m.getTrackLeft)(u);
        u = x(x({}, u), {}, {
          left: T
        });
        var O = (0, m.getTrackCSS)(u);
        ...
        if (t.props.variableWidth) {
          var u = 0, e = 0, n = [], y = (0, m.getPreClones)(x(x(x({}, t.props), t.state), {}, {
          ...
          for (var O = 0; O < y; O++)
            e += n[n.length - 1 - O], u += n[n.length - 1 - O];
          for (var C = 0; C < T; C++)
            u += n[C];
        ...
        var F = i.default.Children.count(t.props.children), B = x(x(x({}, t.props), t.state), {}, {
          slideCount: F
        }), Z = (0, m.getPreClones)(B) + (0, m.getPostClones)(B) + F, V = 100 / t.props.slidesToShow * Z, G = 100 / Z, q = -G * ((0, m.getPreClones)(B) + t.state.currentSlide) * V / 100;
        ...
        for (var y = t.state.currentSlide - 1; y >= -(0, m.getPreClones)(e); y--)
          if (t.state.lazyLoadedList.indexOf(y) < 0) {
            u.push(y);
            break;
          }
        u.length > 0 ? (t.setState(function(T) {
          return {
        ...
        var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, n = t.props, y = n.asNavFor, T = n.beforeChange, O = n.onLazyLoad, C = n.speed, P = n.afterChange, j = t.state.currentSlide, $ = (0, m.slideHandler)(x(x(x({
          index: u
        }, t.props), t.state), {}, {
          trackRef: t.track,
        ...
        if (F) {
          ...
          var Z = F.lazyLoadedList.filter(function(V) {
            return t.state.lazyLoadedList.indexOf(V) < 0;
          });
          O && Z.length > 0 && O(Z), !t.props.waitForAnimate && t.animationEndCallback && (clearTimeout(t.animationEndCallback), P && P(j), delete t.animationEndCallback), t.setState(F, function() {
            y && t.asNavForIndex !== u && (t.asNavForIndex = u, y.innerSlider.slideHandler(u)), B && (t.animationEndCallback = setTimeout(function() {
              var V = B.animating, G = N(B, ["animating"]);
        ...
        var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, n = x(x({}, t.props), t.state), y = (0, m.changeSlide)(n, u);
        if (!(y !== 0 && !y) && (e === !0 ? t.slideHandler(y, e) : t.slideHandler(y), t.props.autoplay && t.autoPlay("update"), t.props.focusOnSelect)) {
          var T = t.list.querySelectorAll(".slick-current");
          T[0] && T[0].focus();
        }
      }), r(d(t), "clickHandler", function(u) {
        t.clickable === !1 && (u.stopPropagation(), u.preventDefault()), t.clickable = !0;
      }), r(d(t), "keyHandler", function(u) {
        var e = (0, m.keyHandler)(u, t.props.accessibility, t.props.rtl);
        e !== "" && t.changeSlide({
          message: e
        });
      }), r(d(t), "selectHandler", function(u) {
        t.changeSlide(u);
      ...
      }), r(d(t), "swipeStart", function(u) {
        t.props.verticalSwiping && t.disableBodyScroll();
        var e = (0, m.swipeStart)(u, t.props.swipe, t.props.draggable);
        e !== "" && t.setState(e);
      }), r(d(t), "swipeMove", function(u) {
        var e = (0, m.swipeMove)(u, x(x(x({}, t.props), t.state), {}, {
          trackRef: t.track,
          listRef: t.list,
          slideIndex: t.state.currentSlide
        }));
        e && (e.swiping && (t.clickable = !1), t.setState(e));
      }), r(d(t), "swipeEnd", function(u) {
        var e = (0, m.swipeEnd)(u, x(x(x({}, t.props), t.state), {}, {
          trackRef: t.track,
          listRef: t.list,
          slideIndex: t.state.currentSlide
        }));
        ...
        else if ((0, m.canGoNext)(x(x({}, t.props), t.state)))
          u = t.state.currentSlide + t.props.slidesToScroll;
        else
          return !1;
        t.slideHandler(u);
      }), r(d(t), "autoPlay", function(u) {
        ...
        var u = (0, b.default)("slick-slider", t.props.className, {
          "slick-vertical": t.props.vertical,
          "slick-initialized": !0
        }), e = x(x({}, t.props), t.state), n = (0, m.extractObject)(e, ["fade", "cssEase", "speed", "infinite", "centerMode", "focusOnSelect", "currentSlide", "lazyLoad", "lazyLoadedList", "rtl", "slideWidth", "slideHeight", "listHeight", "vertical", "slidesToShow", "slidesToScroll", "slideCount", "trackStyle", "variableWidth", "unslick", "centerPadding", "targetSlide", "useCSS"]), y = t.props.pauseOnHover;
        n = x(x({}, n), {}, {
        ...
        if (t.props.dots === !0 && t.state.slideCount >= t.props.slidesToShow) {
          var O = (0, m.extractObject)(e, ["dotsClass", "slideCount", "slidesToShow", "currentSlide", "slidesToScroll", "clickHandler", "children", "customPaging", "infinite", "appendDots"]), C = t.props.pauseOnDotsHover;
          O = x(x({}, O), {}, {
        ...
        var P, j, $ = (0, m.extractObject)(e, ["infinite", "centerMode", "currentSlide", "slideCount", "slidesToShow", "prevArrow", "nextArrow"]);
        ...
        var Z = x(x({}, F), B), V = t.props.touchMove, G = {
...
function Wt() {
  ...
  Qe = 1;
  var i = function(a) {
    return a.replace(/[A-Z]/g, function(g) {
...
function qt() {
  if (et) return ze;
  et = 1;
  var i = Wt(), a = function(m) {
    var S = /[height|width]$/;
    return S.test(m);
  }, g = function(m) {
    var S = "", M = Object.keys(m);
    return M.forEach(function(L, D) {
      var z = m[L];
      L = i(L), a(L) && typeof z == "number" && (z = z + "px"), z === !0 ? S += L : z === !1 ? S += "not " + L : S += "(" + L + ": " + z + ")", D < M.length - 1 && (S += " and ");
    }), S;
  }, b = function(m) {
    var S = "";
    return typeof m == "string" ? m : m instanceof Array ? (m.forEach(function(M, L) {
...
function Ut() {
  return tt || (tt = 1, (function(i) {
    ...
    var a = M(fe), g = Ht(), b = M(qt()), m = M(nt()), S = Se();
    function M(p) {
    ...
    function D() {
      return D = Object.assign ? Object.assign.bind() : function(p) {
        for (var l = 1; l < arguments.length; l++) {
          var r = arguments[l];
          for (var h in r)
            ({}).hasOwnProperty.call(r, h) && (p[h] = r[h]);
        }
        return p;
    ...
    function R(p) {
      for (var l = 1; l < arguments.length; l++) {
        ...
        l % 2 ? z(Object(r), !0).forEach(function(h) {
          s(p, h, r[h]);
        }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(p, Object.getOwnPropertyDescriptors(r)) : z(Object(r)).forEach(function(h) {
    ...
    function s(p, l, r) {
      return (l = c(l)) in p ? Object.defineProperty(p, l, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : p[l] = r, p;
    }
    function c(p) {
      var l = d(p, "string");
    ...
    i.default = /* @__PURE__ */ (function(p) {
      ...
      function r(h) {
        var v;
        return H(this, r), v = l.call(this, h), s(Y(v), "innerSliderRefHandler", function(o) {
          return v.innerSlider = o;
        }), s(Y(v), "slickPrev", function() {
          return v.innerSlider.slickPrev();
        }), s(Y(v), "slickNext", function() {
          return v.innerSlider.slickNext();
        }), s(Y(v), "slickGoTo", function(o) {
          var f = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1;
          return v.innerSlider.slickGoTo(o, f);
        }), s(Y(v), "slickPause", function() {
          return v.innerSlider.pause("paused");
        }), s(Y(v), "slickPlay", function() {
          return v.innerSlider.autoPlay("play");
        }), v.state = {
          breakpoint: null
      ...
      return Q(r, [{
        key: "media",
        value: function(v, o) {
          var f = window.matchMedia(v), w = function(t) {
            var W = t.matches;
            W && o();
          };
        ...
        value: function() {
          ...
          if (this.props.responsive) {
            var o = this.props.responsive.map(function(w) {
              return w.breakpoint;
            });
            o.sort(function(w, k) {
              return w - k;
            }), o.forEach(function(w, k) {
              var t;
              k === 0 ? t = (0, b.default)({
                minWidth: 0,
                maxWidth: w
                ...
                minWidth: o[k - 1] + 1,
                maxWidth: w
              }), (0, S.canUseDOM)() && v.media(t, function() {
                v.setState({
                  breakpoint: w
                });
              });
            ...
            (0, S.canUseDOM)() && this.media(f, function() {
              v.setState({
                breakpoint: null
              });
            });
        ...
        value: function() {
          this._responsiveMediaHandlers.forEach(function(v) {
        ...
        value: function() {
          ...
          if (o === "unslick") {
            var T = "regular slider " + (this.props.className || "");
            return /* @__PURE__ */ a.default.createElement("div", {
              className: T
            }, w);
          } else k.length <= o.slidesToShow && (o.unslick = !0);
...
function Bt({
  ...
  return /* @__PURE__ */ se.createElement("svg", Object.assign({
    ...
    ref: b,
    "aria-labelledby": a
  }, g), i ? /* @__PURE__ */ se.createElement("title", {
    id: a
...
function _e({ rating: i, textAlign: a = "left" }) {
  ...
  const g = a === "center" ? "flex justify-center" : a === "right" ? "flex justify-end" : "flex justify-start", b = [];
  for (let m = 1; m <= 5; m++)
    m <= i ? b.push(
...
function me({
  ...
  const R = (d, p, l) => p.includes(d) ? d : l, H = R(S, ["rounded", "none"], "rounded"), N = R(M, ["left", "center", "right"], "left"), Q = R(L, ["above-author", "below-author", "above-testimonial"], "below-author"), I = m !== null && m >= 1 && m <= 5 ? Math.floor(m) : null, x = () => {
    switch (N) {
      case "center":
        return "text-center";
      case "right":
  ...
  }, ee = ({ authorImage: d, author: p, imageShape: l, textAlign: r }) => {
    const h = l === "rounded" ? "rounded-full" : "rounded-none", v = r === "center" ? `${h} w-auto h-auto max-h-[60px] mx-auto` : `${h} w-48 h-48 max-w-[48px]`;
    return /* @__PURE__ */ _("img", { src: d, alt: p, className: v });
  }, U = ({ author: d, authorTitle: p, textAlign: l }) => /* @__PURE__ */ ae("div", { className: l === "center" ? "flex flex-col items-center" : "flex flex-col", children: [
    /* @__PURE__ */ _("p", { className: "text-xs", children: d }),
    /* @__PURE__ */ _("p", { className: "text-xs", children: p })
  ] }), Y = ({ testimonial: d, textAlign: p }) => /* @__PURE__ */ _("div", { className: `text-body-default ${p === "center" ? "text-center" : p === "right" ? "text-right" : "text-left"}`, children: d }), J = z.alignTop ? "items-start" : "items-center", X = () => {
    switch (N) {
      case "right":
        return "items-end";
      case "center":
  ...
  if (N !== "center") {
    ...
    return /* @__PURE__ */ _("div", { className: `relative flex self-stretch justify-center ${D} ${J} w-full`, children: /* @__PURE__ */ ae("div", { className: `flex flex-col gap-testimonial-spacing-y w-full text-grey-950 ${x()}`, children: [
  ...
  return Q === "above-testimonial" ? /* @__PURE__ */ _("div", { className: `relative flex self-stretch justify-center ${D} ${J} w-full`, children: /* @__PURE__ */ ae("div", { className: `flex flex-col gap-10 w-full text-grey-950 ${x()}`, children: [
    /* @__PURE__ */ _(
      ee,
      {
        authorImage: b,
  ...
  ] }) }) : Q === "above-author" ? /* @__PURE__ */ _("div", { className: `relative flex self-stretch justify-center ${D} ${J} w-full`, children: /* @__PURE__ */ ae("div", { className: `flex flex-col gap-10 w-full text-grey-950 ${x()}`, children: [
    I && /* @__PURE__ */ _(_e, { rating: I, textAlign: N }),
    /* @__PURE__ */ _(
      Y,
      {
  ...
  ] }) }) : /* @__PURE__ */ _("div", { className: `relative flex self-stretch justify-center ${D} ${J} w-full`, children: /* @__PURE__ */ ae("div", { className: `flex flex-col gap-10 w-full ${x()}`, children: [
    I && /* @__PURE__ */ _(_e, { rating: I, textAlign: N }),
    /* @__PURE__ */ _(
      Y,
      {
...
const be = ({
  ...
  var I;
  const R = `relative w-full h-full ${a === "square" ? "aspect-square" : a === "rectangle" ? "aspect-[4/3]" : i === "video" ? "aspect-video" : ""}`.trim(), H = a === "default" ? `w-full h-full ${D}`.trim() : `absolute inset-0 w-full h-full ${D}`.trim(), N = "w-full h-full", Q = a === "default" ? `min-h-[220px] md:min-h-[360px] ${H}`.trim() : H;
  switch (i) {
    case "image":
      if (g)
        return /* @__PURE__ */ _("div", { className: R, children: /* @__PURE__ */ _(
          "img",
          {
            src: g,
            alt: L || "Media image",
    ...
    case "video":
      if (b) {
        let x = b;
        return (b.includes("youtube.com/watch") || b.includes("youtu.be/")) && (x = `https://www.youtube.com/embed/${b.includes("youtu.be/") ? b.split("youtu.be/")[1].split("?")[0] : (I = b.split("v=")[1]) == null ? void 0 : I.split("&")[0]}`), /* @__PURE__ */ _("div", { className: R, children: /* @__PURE__ */ _(
          "iframe",
          {
            src: x,
    ...
    case "lottie":
      if (S)
        return /* @__PURE__ */ _("div", { className: R, children: /* @__PURE__ */ _("div", { className: `${H} overflow-hidden`.trim(), children: /* @__PURE__ */ _(
          ft,
          {
            animationData: S,
            loop: !0,
      ...
      if (m)
        return /* @__PURE__ */ _("div", { className: R, children: /* @__PURE__ */ _("div", { className: "absolute inset-0 flex items-center justify-center text-grey-900 text-body-default text-center p-40", children: "Loading Lottie animation..." }) });
      break;
    case "iframe":
      if (M)
        return /* @__PURE__ */ _("div", { className: R, children: /* @__PURE__ */ _(
...
function Jt({
  ...
  const H = (h, v, o) => v.includes(h) ? h : o, N = H(i, ["media", "column", "stacked-media", "trust-strip"], "column"), Q = H(b, ["media-first", "testimonial-first"], "testimonial-first"), I = H(m, [1, 2, 3, 4, 5], 2), x = H(S, ["left", "center", "right"], "left"), ee = H(M, ["above-author", "below-author", "above-testimonial"], "below-author"), U = H(L, ["rounded", "none"], "rounded"), Y = ["column", "stacked-media"].includes(N), J = ["trust-strip"].includes(N), X = {
    textAlign: x,
    imagePlacement: ee,
    imageShape: U,
    alignTop: Y
    // Use items-start for grid layouts, items-center for media layouts
  }, s = We(() => !a || a.length === 0 ? 0 : N === "media" ? a.length : Math.ceil(a.length / I), [N, a, I]), c = "relative inline-block w-auto h-auto m-0 p-0 cursor-pointer", d = "text-[0] leading-[0] block w-[12px] h-[12px] p-0 cursor-pointer text-transparent border-0 outline-none bg-grey-700 rounded-full transition-opacity duration-300 ease-[ease]", p = We(() => {
    if (!a || a.length === 0)
      return [];
    if (N === "media")
      return a.map((v) => [v]);
    const h = [];
    for (let v = 0; v < a.length; v += I)
      h.push(a.slice(v, v + I));
    return h;
  }, [N, a, I]), l = {
    ...
    appendDots: (h) => /* @__PURE__ */ _("div", { className: "relative flex justify-center items-center w-auto m-0 p-0 z-10 mt-40", children: /* @__PURE__ */ _("ul", { className: "flex p-10 items-center gap-10 rounded-full border border-grey-300 w-auto m-0 list-none text-center shadow-sm bg-grey-800 mt-40", children: ct.map(h, (v) => {
      var k, t, W;
      if (!qe(v))
        return v;
      const o = (((k = v.props) == null ? void 0 : k.className) || "").includes("slick-active"), f = (t = v.props) == null ? void 0 : t.children, w = qe(f) ? Ue(f, {
  ...
  }, r = (h, v) => v ? x === "center" ? "p-testimonial-padding xl:px-testimonial-padding" : h ? "pt-testimonial-padding xl:pl-testimonial-padding" : "pb-testimonial-padding xl:pb-0 xl:pr-testimonial-padding" : "";
  if (J)
    return !a || a.length === 0 || !!!a.some((v) => {
      var o, f;
      return ((o = v.media) == null ? void 0 : o.imageUrl) || ((f = v.media) == null ? void 0 : f.iframeUrl);
    }) ? null : /* @__PURE__ */ _("div", { className: R, id: z, children: /* @__PURE__ */ _(De, { ...l, children: a.map((v, o) => {
      const f = v.media, w = (f == null ? void 0 : f.type) || "image";
      return /* @__PURE__ */ _("div", { className: "h-[220px]", children: /* @__PURE__ */ _(
        be,
        {
          media: w,
          aspect: "default",
  ...
  if (N === "media") {
    if (!a || a.length === 0)
      return null;
    const h = Q === "media-first", v = (o) => {
      const f = o.media, w = !!f, k = w ? "xl:w-1/2" : "w-full", t = r(h, w);
      return w ? /* @__PURE__ */ ae("div", { className: "flex flex-col xl:flex-row items-stretch text-gray-950", children: [
        h && /* @__PURE__ */ _("div", { className: "relative w-full xl:w-1/2 h-full min-h-[220px] overflow-hidden", children: /* @__PURE__ */ _("div", { className: "absolute inset-0 w-full h-full", children: /* @__PURE__ */ _(
          be,
          {
            media: f.type || "image",
            aspect: "default",
        ...
        /* @__PURE__ */ _("div", { className: `relative flex self-stretch justify-center items-center ${k} ${t}`, children: /* @__PURE__ */ _(
          me,
          {
  ...
  if (N === "column") {
    ...
    return !D || s <= 1 ? /* @__PURE__ */ _("div", { className: `relative ${R}`, id: z, children: /* @__PURE__ */ _("div", { className: h(), children: a.map((v, o) => /* @__PURE__ */ _(
      me,
      {
      ...
      o
    )) }) }) : /* @__PURE__ */ _("div", { className: R, id: z, children: /* @__PURE__ */ _(De, { ...l, children: p.map((v, o) => /* @__PURE__ */ _("div", { children: /* @__PURE__ */ _("div", { className: h(), children: v.map((f, w) => /* @__PURE__ */ _(
      me,
      {
  ...
  if (N === "stacked-media") {
    if (!a || a.length === 0)
      return null;
    const h = Q === "media-first", v = !!g, o = r(h, v);
    return /* @__PURE__ */ _("div", { className: `relative ${R}`, id: z, children: /* @__PURE__ */ ae("div", { className: "flex flex-col xl:flex-row items-stretch", children: [
      h && v && /* @__PURE__ */ _("div", { className: "relative w-full xl:w-1/2 min-h-[400px] xl:min-h-0 overflow-hidden", children: /* @__PURE__ */ _("div", { className: "absolute inset-0 w-full h-full", children: /* @__PURE__ */ _(
        be,
        {
          media: g.type || "image",
          aspect: "default",
      ...
      /* @__PURE__ */ _("div", { className: `relative flex flex-col justify-center gap-24 ${v ? "w-full xl:w-1/2" : "w-full"} ${o}`, children: a.map((f, w) => /* @__PURE__ */ _(
        me,
        {
          testimonial: f.testimonial,
          author: f.author,
