import { jsx as e, jsxs as M, Fragment as z } from "react/jsx-runtime";
import * as C from "react";
import { lazy as W, Suspense as I, useState as P, useRef as O, useEffect as A, useCallback as T, forwardRef as _ } from "react";
...
const V = W(() => Promise.resolve().then(() => le)), H = ({
  ...
  var f;
  const d = typeof window < "u" && window.location.origin.indexOf("author") > -1, o = typeof window < "u" && window.matchMedia("(prefers-reduced-motion: reduce)").matches, p = `relative w-full h-full ${r === "square" ? "aspect-square" : r === "rectangle" ? "aspect-[4/3]" : t === "video" ? "aspect-video" : ""}`.trim(), c = r === "default" ? `w-full h-full ${n}`.trim() : `absolute inset-0 w-full h-full ${n}`.trim(), y = "w-full h-full", N = r === "default" ? `${c}`.trim() : c, v = i === "contain" ? "object-contain" : "object-cover", $ = i === "contain" ? "xMidYMid meet" : "xMidYMid slice", u = `relative w-full ${n}`.trim(), h = "w-full min-h-[280px]";
  switch (t) {
    case "image":
      if (a)
    ...
    case "video":
      if (s) {
        const L = s.includes("youtube.com/watch") || s.includes("youtu.be/");
        let j = s;
        L && (j = `https://www.youtube.com/embed/${s.includes("youtu.be/") ? s.split("youtu.be/")[1].split("?")[0] : (f = s.split("v=")[1]) == null ? void 0 : f.split("&")[0]}`);
        const E = (() => {
          if (!L) return j;
          try {
            const k = new URL(j);
        ...
        return /* @__PURE__ */ e("div", { className: p, children: L ? /* @__PURE__ */ e(
          "iframe",
          {
            src: E,
    ...
    case "flipbook":
      if (m)
        ...
        ) }) : /* @__PURE__ */ e("div", { className: u, children: /* @__PURE__ */ e("div", { className: h, children: /* @__PURE__ */ e(I, { fallback: /* @__PURE__ */ e("div", { children: "Loading PDF..." }), children: /* @__PURE__ */ e(V, { pdfUrl: m, title: l, className: "w-full" }) }) }) });
      break;
  }
...
function U({
  ...
  const g = {
    ...
    right: "ml-auto",
    center: "mx-auto"
  }, m = ["center", "left", "right"].includes(a) ? a : "center", l = ["sm", "md", "lg", "xl"].includes(s) ? s : "sm", n = g[l], d = x[m], o = b[m], w = t ? {
    media: t.media || "image",
  ...
  return /* @__PURE__ */ M(
    "div",
    {
      ...
      style: { textAlign: m },
      children: [
        t && w && /* @__PURE__ */ e("div", { className: `flex flex-col items-${d} justify-${d}`, children: /* @__PURE__ */ e("div", { className: `w-48 h-48 max-w-full max-h-full rounded-full overflow-hidden ${o}`, children: /* @__PURE__ */ e(H, { ...w }) }) }),
        r && /* @__PURE__ */ e("div", { className: `${n} font-normal`, children: r }),
...
function Y({
  ...
  return /* @__PURE__ */ C.createElement("svg", Object.assign({
    ...
    ref: a,
    "aria-labelledby": r
  }, i), t ? /* @__PURE__ */ C.createElement("title", {
    id: r
...
const Z = /* @__PURE__ */ C.forwardRef(Y);
function G({
  title: t,
  titleId: r,
  ...i
...
const J = /* @__PURE__ */ C.forwardRef(G);
...
function Q({
  ...
  const d = a !== null && a >= 1 && a <= 5 ? Math.floor(a) : null, o = b === "center", w = `w-full ${m ? "p-testimonial-padding" : ""} ${l}`.trim(), p = o ? "text-center items-center" : "text-left items-start", c = [
    g ? /* @__PURE__ */ e(
      "img",
      {
        src: g,
  ...
  return /* @__PURE__ */ e("figure", { className: w, ...n, ...n.attributes || {}, children: /* @__PURE__ */ M("div", { className: `flex flex-col gap-testimonial-spacing-y ${p}`, children: [
...
function ae({
  ...
  return !t || t.length === 0 ? null : /* @__PURE__ */ e("div", { className: `container ${g}`, id: s, children: t.map((l, n) => {
    const {
      ...
      withPadding: c,
      logoUrl: y
    } = l, N = l.name ?? l.author, v = l.role ?? l.authorTitle, $ = l.imageUrl ?? l.authorImage, u = !!d, h = `min-h-auto! ${u ? "xl:w-1/2" : "w-full"}`, f = a === "testimonial-first";
...
}, ee = _(({ children: t }, r) => /* @__PURE__ */ e("div", { ref: r, className: "w-full h-full overflow-hidden", children: t })), te = ({ pdfUrl: t, title: r, width: i = 280, height: a = 280, className: s = "" }) => {
  const [g, x] = P(0), [b, m] = P(null), [l, n] = P(!0), [d, o] = P(a / i), [w, p] = P(0), c = O(null);
  A(() => {
    Promise.all([X(), D()]).then(() => n(!1)).catch(() => {
