...
const L = ({
  ...
  let l;
  const u = `relative w-full h-full ${i === 'square' ? 'aspect-square' : i === 'rectangle' ? 'aspect-[4/3]' : t === 'video' ? 'aspect-video' : ''}`.trim(); const o = i === 'default' ? `w-full h-full ${d}`.trim() : `absolute inset-0 w-full h-full ${d}`.trim(); const m = 'w-full h-full'; const
    y = i === 'default' ? `${o}`.trim() : o;
  switch (t) {
    case 'image':
      if (a) {
    ...
    case 'video':
      if (r) {
        let s = r;
        return (r.includes('youtube.com/watch') || r.includes('youtu.be/')) && (s = `https://www.youtube.com/embed/${r.includes('youtu.be/') ? r.split('youtu.be/')[1].split('?')[0] : (l = r.split('v=')[1]) == null ? void 0 : l.split('&')[0]}`), /* @__PURE__ */ e('div', {
          className: u,
          children: /* @__PURE__ */ e(
            'iframe',
            {
    ...
    case 'lottie':
      if (p) {
        return /* @__PURE__ */ e('div', {
          ...
          children: /* @__PURE__ */ e('div', {
            className: `${o} overflow-hidden`.trim(),
            children: /* @__PURE__ */ e(
              E,
              {
                animationData: p,
      ...
      if (n) return /* @__PURE__ */ e('div', { className: u, children: /* @__PURE__ */ e('div', { className: 'absolute inset-0 flex items-center justify-center text-body-default text-center p-40', children: 'Loading Lottie animation...' }) });
      break;
    case 'iframe':
      if (f) {
        return /* @__PURE__ */ e('div', {
...
function U({
  ...
  const p = {
    ...
    right: 'ml-auto',
    center: 'mx-auto',
  }; const d = ['center', 'left', 'right'].includes(r) ? r : 'center'; const g = ['sm', 'md', 'lg', 'xl'].includes(n) ? n : 'sm'; const u = p[g]; const o = f[d]; const m = h[d]; const
    y = t ? {
      media: t.media || 'image',
...
function z({
  ...
  return /* @__PURE__ */ v.createElement('svg', {
    ...
    'aria-labelledby': i,
    ...a,
  }, t ? /* @__PURE__ */ v.createElement('title', {
    id: i,
...
function I({ rating: t, textAlign: i = 'left' }) {
  ...
  const a = i === 'center' ? 'flex justify-center' : i === 'right' ? 'flex justify-end' : 'flex justify-start';
  const r = [];
  for (let n = 1; n <= 5; n++) {
    n <= t ? r.push(
...
function q({
  ...
  const o = r !== null && r >= 1 && r <= 5 ? Math.floor(r) : null; const m = h === 'center'; const y = `w-full ${d ? 'p-testimonial-padding' : ''} ${g}`.trim(); const l = m ? 'text-center items-center' : 'text-left items-start'; const s = p ? 'h-40 w-auto' : 'h-48 w-48 rounded-full object-cover'; const c = p || n; const x = c && f === 'top'; const N = c && f === 'bottom'; const
    b = c && f === 'with-name';
  return /* @__PURE__ */ e('div', {
    className: y,
    ...u,
    ...
    children: /* @__PURE__ */ w('div', {
      className: `flex flex-col gap-testimonial-spacing-y ${l}`,
      children: [
        x && /* @__PURE__ */ e(
          'img',
          {
        ...
        (i || a) && /* @__PURE__ */ w(
          'div',
          {
            ...
            children: [
              b && /* @__PURE__ */ w('div', {
                className: `flex items-center gap-10 ${m ? 'justify-center' : 'justify-start'}`,
                children: [
                  /* @__PURE__ */ e(
                    'img',
                    {
                  ...
                  /* @__PURE__ */ w('div', {
                    className: `flex flex-col ${m ? 'items-center' : 'items-start'}`,
                    children: [
...
function W({
  ...
  const f = (l, s, c) => (s.includes(l) ? l : c);
  const h = (l) => {
  ...
  const u = (l) => {
    const s = l.media; const c = !!s; const x = `bg-grey-100 ${c ? 'xl:w-1/2' : 'w-full'}`; const
      N = h(l) === 'left';
    return /* @__PURE__ */ w('div', {
      ...
      children: [
        N && g(l, x),
        c && /* @__PURE__ */ e('div', {
          className: 'relative w-full xl:w-1/2 h-full min-h-[220px] overflow-hidden bg-[#C8D4FE]',
          children: /* @__PURE__ */ e('div', {
  ...
  const o = (l) => {
    const {
      ...
      withPadding: b,
      logoUrl: k,
    } = l; const A = l.name ?? l.author; const B = l.role ?? l.authorTitle; const $ = l.imageUrl ?? l.authorImage; const C = !!s; const j = `min-h-auto! ${C ? 'xl:w-1/2' : 'w-full'}`; const M = h(l) === 'left'; const
      S = {
        ...d(l),
        media: $ ? {
          media: 'image',
    ...
    return /* @__PURE__ */ w('div', {
      className: 'flex flex-col items-stretch xl:flex-row text-gray-950',
      children: [
        M && g(S, j),
        C && /* @__PURE__ */ e(
          'div',
